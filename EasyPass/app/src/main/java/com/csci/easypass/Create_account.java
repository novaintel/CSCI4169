...
public class Create_account extends Activity {
    ...
    MySQLiteHelper db;
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
         ...
         usernameTextBox=new TextView(this);
         usernameTextBox=(TextView)findViewById(R.id.create_username);

         passwordTextBox=new TextView(this);
         passwordTextBox=(TextView)findViewById(R.id.create_password);

         passwordAgainTextBox=new TextView(this);
         passwordAgainTextBox=(TextView)findViewById(R.id.create_reenter_password);

         db = new MySQLiteHelper(this);

         final Button createAccButton = (Button) findViewById(R.id.create_account_btn);
